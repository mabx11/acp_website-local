<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
         pageEncoding="ISO-8859-1" import="entidades.Genero, datos.Dt_Genero, vistas.VW_RolUsuario, datos.Dt_RolOpciones, java.util.*;" %>
<%
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="tblGenero" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td><%=ge.getDescripcion() %>
                                </td>
                                <td><%=ge.getEstado() != 3 ? "Activo" : "Inactivo" %>
                            	</td>
	                        	<td>
	                         		<a id="btn-edita-abrir" href="EditarGenero.jsp?generoID=<%=ge.getGeneroID() %>"> 
	                         		<i class="fas fa-edit" title="Editar género"></i></a>
	                        		...
	                        		<a class="ajax-link" href="javascript:void(0);" 
	                           		onclick="$.jAlert({
	                           		    ...
	                           		    'onConfirm': function(e, btn){
	                           		      ...
	                           		      window.location.href = 'Sl_GestionGenero?generoID=<%=ge.getGeneroID()%>';
...
<script>
        ...
        if(mensaje == "1")
    	{
       	 //successAlert('Éxito', 'Los datos del genero han sido registrados exitosamente');
            $.jAlert({
                'title': 'Éxito',
                'content': 'Los datos del género han sido registrados exitosamente',
                'theme': 'green',
		...
		if(mensaje == "3")
		{
			//successAlert('Éxito', 'Los datos del genero han sido actualizados exitosamente');
            $.jAlert({
                'title': 'Éxito',
