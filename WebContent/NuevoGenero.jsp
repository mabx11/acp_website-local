...
<main id="main">
    ...
    <section id="about" class="about">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <br>
              <form  method="post" class="genero" action="./Sl_GestionGenero">
                <div class="row gy-4">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control form-control-user" name="txtDescripcionG" id="txtDescripcionG" rows="6" placeholder="Descripción del Género"
                                  required></textarea>
                    </div>
                </div>
                <br>
		...
		if (mensaje == "existe") {
			...
			$.jAlert({
                ...
                'onClose': function(OnClose) {               
                    window.location = "NuevoGenero.jsp";
                }
              });
		}
