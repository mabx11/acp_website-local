<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"
         import="vistas.VW_RolUsuario, entidades.RolUsuario, datos.Dt_RolUsuario, datos.Dt_RolOpciones, java.util.*;" %>
<%
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 row">
                    ...
                    <div class="col" align="right">
                        ...
                        <a href="NuevoRolUser.jsp" data-toggle="modal" data-target="#modalNuevoRolUser">
                            <i class="fas fa-file-medical fa-2x" title="Agregar nuevo rol a usuario"></i>
                        </a>&nbsp;&nbsp;
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="tblRolUser" width="100%" cellspacing="0">
                            <%
                                ArrayList<VW_RolUsuario> listRolUser = new ArrayList<VW_RolUsuario>();
                                Dt_RolUsuario dtru = new Dt_RolUsuario();
                                listRolUser = dtru.listaRolUser();
                            ...
                            <tbody>
                            <%
                                for (VW_RolUsuario us : listRolUser) {
                            %>
                            <tr>
                                <td><%=us.getID() %>
                                </td>
                                ...
                                <td class="text-center">
                                    <a id="btn-edita-abrir" href="editRolUsuario.jsp?rol_usuarioID=<%=us.getID()%>">
                                        <i class="fas fa-edit" title="Editar rol usuario"></i>
                                    </a>
                                    <a class="ajax-link" href="javascript:void(0);" 
                                           		onclick="$.jAlert({
                                           		    ...
                                           		    'onConfirm': function(e, btn){
                                           		      ...
                                           		      window.location.href = 'Sl_GestionRolUser?rol_usuarioID=<%=us.getID()%>';
                        							...
                        							<i class="fas fa-trash-alt" title="Eliminar rol usuario"></i>
                        						</a> 
        ...
        if(mensaje == "1")
        {
            ...
            $.jAlert({
                ...
                'onClose': function(OnClose) {               
                    window.location = "tblRolUser.jsp";
                }
              });
        }
        if(mensaje == "2")
