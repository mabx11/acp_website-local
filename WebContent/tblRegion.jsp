<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
         pageEncoding="ISO-8859-1" import="entidades.Region, datos.Dt_Region, vistas.VW_RolUsuario, datos.Dt_RolOpciones, java.util.*;" %>
<%
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 row">
                    <div class="col">
                        <h1 class="h3 mb-2 text-gray-800">Gestión de Región</h1>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="tblRegion" width="100%" cellspacing="0">
                            <%
                            ...
                            <tr>
                                ...
                                <td><%=re.getEstado() != 3 ? "Activo" : "Inactivo" %>
	                       	   </td>
