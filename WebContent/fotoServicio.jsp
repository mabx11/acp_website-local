...
<main id="main">
    ...
    <section id="about" class="about">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <h2 class="form-header" style="color: black;">Registrar Imagen en el servicio</h2>
            <br>
            <%
					int idservicio = 0;
					...
					serv = dtser.getServicio(idservicio);
				%>
				
            <form  method="post" class="user" name="frm-foto" enctype="multipart/form-data" action="./Sl_FotoServicio">
                <div class="row gy-4">
                    <div class="col-md-12">
                    <div class="cuadro-fotoNima" align="center">
						<img id="preview" src="<%=serv.getFoto()==null?"#":serv.getFoto()%>" name="preview"  alt="Foto Servicio"
									style="max-width: 400px; max-height: 400px; border-bottom-color: white; margin: 2px;" />
                    </div>
