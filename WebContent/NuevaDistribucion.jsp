<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
         ...
         import="entidades.Distribucion, datos.Dt_Distribucion, entidades.Pais, datos.Dt_Pais, vistas.VW_PaisRegion, vistas.VW_RolUsuario, datos.Dt_RolOpciones, java.util.*;" %>
<%
            ...
            <input name="opcion" type="hidden" value="1"/>
                ...
                <div class="row gy-4">
                    ...
                    <div class="row col-md-12">
                        ...
                        <div class="col-sm-1">
                            <a title="Agregar nuevo país" href="NuevoPais.jsp">
...
/* 		if (mensaje == "existe") {
		...
		if (mensaje == "existe") {
			//errorAlert('Error','Los datos de la distribución que está intentando registrar ya existen en la base de datos');
			$.jAlert({
               'title': 'Error',
               'content': 'Los datos de la distribución que está intentando registrar ya existen en la base de datos',
               'theme': 'red',
