...
<main id="main">
    ...
    <section id="about" class="about">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <h2 class="form-header" style="color: black;">Guardar un documento</h2>
            <br>
            <%
					...
					pub = dtpu.getPubli(publicacionesid);
				%>
				
            <form  method="post" class="user" name="frm-document" enctype="multipart/form-data" action="./Sl_Documento">
                <div class="row gy-4">
                    <div class="col-md-12">
                    <div class="cuadro-fotoNima" align="center">
						<img id="preview" src="<%=pub.getMultimedia()==null?"#":pub.getMultimedia()%>" name="preview"  alt="Documento"
									style="width: 400px; height: 400px; border-bottom-color: white; margin: 2px;" />
                    </div>

                    <div class="col-md-12">
                       <input type="file" id="documento" name="documento" onchange="Test.UpdatePreview(this)" required="required">&nbsp; 
								
								<input type="hidden" name="publicacionesid" value="<%=publicacionesid%>">
                    </div>
                </div>
                <br>
