...
<main id="main">
    ...
    <section id="about" class="about">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <form  method="post" class="familia" action="./Sl_GestionFamilia">
...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
		...
		if (mensaje == "existe") {
			...
			$.jAlert({
                'title': 'Error',
                'content': 'Los datos de la familia que está intentando registrar ya existen en la base de datos',
                'theme': 'red',
                'onClose': function(OnClose) {               
                    window.location = "NuevaFamilia.jsp";
                }
              });
		}
