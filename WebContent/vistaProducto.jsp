    ...
    <section id="about" class="about">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div>
               	...
               	<%
                String vipr = "";
				vipr = request.getParameter("ProductoID")==null?"0":request.getParameter("ProductoID");
										
				VW_Productos vwp = new VW_Productos();
				Dt_Productos dtvp = new Dt_Productos();
				vwp = dtvp.getVwProducto(Integer.parseInt(vipr));
				
				CatProductos prod = new CatProductos();
				Dt_Productos dtp = new Dt_Productos();
				prod = dtp.getProducto(Integer.parseInt(vipr));
				
				ArrayList<VW_Productos> listVwProductos = new ArrayList<VW_Productos>();
				listVwProductos = dtvp.listaVwProductos();
                ...
                <div class="contenido-arboles formulario">
					...
					<table class="default table table-bordered center">
					  ...
					  <tr>
					    <th colspan="3" style="background-color:#081C44; text-align:center; color:white"> <%=vwp.getNombre()%> </th>
					  </tr>
					
					  <tr>
					  	<td style="text-align:center; vertical-align: middle;" rowspan="7">
	                       	<img style="width: 200px; height: 200px; object-fit: cover;" name="imgProd" id="imgProd" src="<%=prod.getFoto()==null?"#":prod.getFoto()%>" onerror="this.onerror=null;this.src='https://cdn-icons-png.flaticon.com/512/1170/1170577.png';">
	                	</td>
	                   ...
	                   <tr>
	                   	<th>Categoría</th>
	                   	<td> <div name="categoria" id="categoria"><%= vwp.getTipoProducto()%></div> </td>
	                   </tr>
	                    ...
	                    <tr>
	                    	<th> Descripción</th>
	                    	<td> <div name="txaDescripcion" id="txaDescripcion"><%=vwp.getDescripcion()%></div> </td>
	                    </tr>
                    ...
                    <form id="myDIV" method="post" action="./Sl_GestionProductos" style="display: none;" class="rol">
						<div class="row gy-4">
							<div class="col-sm-12">
							<input name="ProductoID" type="hidden" value="<%=vwp.getID() %>" />
