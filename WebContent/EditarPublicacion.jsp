            ...
            <input name="PublicacionesID" type="hidden" value="<%=pub.getPublicacionesid()%>" />
             <input name="opcion" type="hidden" value="2" />
                ...
                <div class="form-group col-sm-9">
                    <div class="col-sm-12 mb-3 mb-sm-0">
							<input type="text" class="form-control form-control-user"
								name="txtTitulo" id="txtTitulo" title="Título de la publicación"
								placeholder="Título de publicación" required>
				    </div>
				    <br>
					<div class="col-sm-10 mb-3 mb-sm-0">
							<textarea class="form-control form-control-user" title="Texto que contiene la publiación"
                ...
                <div class="form-group col-sm-3">
						<select class="form-select" name="selTipoPu" id="selTipoPu" title="Seleccione el estado de la publicación" required>
                            <option value="Visible" title="Visible a todos">Visible</option>
                            <option value="Oculta" title="Oculto a visitantes">Oculto</option>
                            <option value="Borrador" title="Aún no es publicado">Borrador</option>
                        </select>
				</div>
                <br>
                <!-- Botones -->
   ...
   $(document).ready(function()
	{
	   ...
	   $("#selTipoPu").val("<%=pub.getTipopubli()%>");
		...
		if (mensaje == "existe") {
			...
			$.jAlert({
                'title': 'Error',
                'content': 'El titulo de la publicación que esta intentando registrar ya existe en la base de datos! Intentelo otra vez!',
                'theme': 'red',
