    ...
    <section id="about" class="about">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <%
					...
					eve = dte.getEventos(idevento);
				%>
				
            <form  method="post" class="user" name="frm-foto" enctype="multipart/form-data" action="./Sl_FotoEvento">
                <div class="row gy-4">
                    <div class="col-md-12">
                    <div class="cuadro-fotoNima" align="center">
						<img id="preview" src="<%=eve.getHipervinculo()==null?"#":eve.getHipervinculo()%>" name="preview"  alt="Foto Evento"
