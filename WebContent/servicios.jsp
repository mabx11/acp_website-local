        ...
        <div class="container">
            ...
            <div id="button-edicion" class="button-edicion">
                <a href="tblServicios.jsp">
                    <button> Administrar servicios</button>
                </a>
            </div>
            ...
            <div class="row servicios">
                ...
                %>
                <div class="col-lg-6">
					<a href="EditarServicio.jsp?ServicioID=<%=ser.getServiciosid() %>">
					<div class="d-flex flex-column justify-content-center">
                        <div id="Content-vision" class="Content-vision content">
                            <div>
                                <img style="width: 100px; height: 100px; border-radius: 50%;" src="<%=ser.getFoto()==null?"#":ser.getFoto()%>" onerror="this.onerror=null;this.src='http://sistemas.itslp.edu.mx/wp-content/uploads/2013/07/icono-bolsatrabajo1.png';">
                            </div>
                            <div>
                                <h2 class="text-center"><%=ser.getNombre() %></h2>
                            </div>
                            ...
                            <div class="col" align="right"> 
		                        ...
		                        <br>
		                        <br>
							    <i style="color: black;" class="text-right"><%=ser.getDisponibilidad() %></i>
							</div>
                        </div>
                    </div>
                    </a>
