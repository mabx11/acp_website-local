   ...
   $(document).ready(function()
	{
	   ...
	   $("#cbxRegion").val("<%=pai.getRegionID()%>");
		...
		if (mensaje == "existe") {
			//errorAlert('Error','Los datos del país que está intentando registrar ya existen en la base de datos');
			$.jAlert({
	             'title': 'Error',
	             'content': 'Los datos del país que está intentando registrar ya existen en la base de datos',
	             'theme': 'red',
