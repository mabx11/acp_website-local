<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
         pageEncoding="ISO-8859-1" import="entidades.Familia, datos.Dt_Familia, vistas.VW_RolUsuario, datos.Dt_RolOpciones, java.util.*;" %>
<%
	               ...
	               <div class="table-responsive">
	                   <table class="table table-bordered" id="tblFamilia" width="100%" cellspacing="0">
	                       ...
	                       <tr>
	                           ...
	                           <td>
	                           		<a id="btn-edita-abrir" href="EditarFamilia.jsp?familiaID=<%=fa.getFamiliaID() %>"> <i
	                                   class="fas fa-edit" title="Editar familia"></i></a>
...
<script src="jAlert/dist/jAlert-functions.min.js"> //optional!!</script>
 	...
 	<script>
        ...
        if(mensaje == "1")
        {
            ...
            $.jAlert({
                'title': 'Éxito',
                'content': 'Los datos de la familia han sido registrados exitosamente',
                'theme': 'green',
        ...
        if(mensaje == "3")
        {
        	 //successAlert('Éxito', 'Los datos del árbol han sido actualizados exitosamente');
            $.jAlert({
                'title': 'Éxito',
