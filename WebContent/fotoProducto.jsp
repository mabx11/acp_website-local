...
<main id="main">
    ...
    <section id="about" class="about">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <h2 class="form-header" style="color: black;">Registrar Imagen en el producto</h2>
            <br>
            <%
					int idproducto = 0;
					...
					prod = dtp.getProducto(idproducto);
				%>
				
            <form  method="post" class="user" name="frm-foto" enctype="multipart/form-data" action="./Sl_FotoProducto">
                <div class="row gy-4">
                    <div class="col-md-12">
                    <div class="cuadro-fotoNima" align="center">
						<img id="preview" src="<%=prod.getFoto()==null?"#":prod.getFoto()%>" name="preview"  alt="Foto Producto"
