<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
         ...
         import="entidades.Usuario, datos.Dt_Usuario, datos.Dt_RolOpciones, vistas.VW_RolUsuario, java.util.*;" %>
<%
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 row">
                    ...
                    <div class="col" align="right">
                        <!-- Button agregar -->
                        <a href="NuevoUsuario.jsp" data-toggle="modal"
                           data-target="#modalNuevoUsuario"> <i
                                class="fas fa-user-plus fa-2x" title="Agregar nuevo usuario"></i>
                        </a>&nbsp;&nbsp; 
                        
                        <!-- Button asignar -->
                        <a href="tblRolUser.jsp">
                            <button style="background-color: #0e203f; color: white"> Asignar Rol </button>
                        </a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="tblUsers" width="100%"
                               cellspacing="0">
                            <%
                            ...
                            <tr>
                                ...
                                <td><%=us.getEstado() != 0 ? "Activo" : "Inactivo" %>
                                </td>
...
<script>
    $(document).ready(function () {
        ...
        if(mensaje == "1")
        {
            //successAlert('Éxito', 'Los datos del usuario han sido registrados exitosamente');
            $.jAlert({
                'title': 'Éxito',
                'content': 'Los datos del usuario han sido registrados exitosamente, se envió un correo al usuario para que valide su registro!',
                'theme': 'green',
                'onClose': function(OnClose) {               
                    window.location = "tblUsuarios.jsp";
                }
              });
        }
        if(mensaje == "2")
        ...
        if(mensaje == "5")
        {
            ...
            $.jAlert({
                'title': 'Éxito',
                'content': 'El usuario ha sido dado de baja exitosamente',
                'theme': 'green',
                'onClose': function(OnClose) {               
                    window.location = "tblUsuarios.jsp";
                }
