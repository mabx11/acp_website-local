<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
         ...
         import="entidades.Distribucion, vistas.VW_Distribucion, datos.Dt_Distribucion, vistas.VW_RolUsuario, datos.Dt_RolOpciones, java.util.*;" %>
<%
                                    ...
                                    <a class="ajax-link" href="javascript:void(0);" 
                               		onclick="$.jAlert({
                               		    ...
                               		    'onConfirm': function(e, btn){
                               		      ...
                               		      window.location.href = 'Sl_GestionDistribucion?DistribucionID=<%=dis.getID()%>';
...
$(document).ready(function () {
	   ...
	   /////////// VARIABLE DE CONTROL MSJ ///////////
        ...
        if(mensaje == "1")
        {
        	//successAlert('Éxito', 'Los datos de la distribución han sido registrados exitosamente');
            $.jAlert({
                'title': 'Éxito',
                'content': 'Los datos de la distribución han sido registrados exitosamente',
                'theme': 'green',
