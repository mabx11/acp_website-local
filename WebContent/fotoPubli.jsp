...
<main id="main">
    ...
    <section id="about" class="about">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <h2 class="form-header" style="color: black;">Registrar Imagen en la Publicación</h2>
            <br>
            <%
					int idpubli = 0;
					Publicaciones pub = new Publicaciones();
					Dt_Publicaciones dtpu = new Dt_Publicaciones();
					idpubli = Integer.parseInt(request.getParameter("idPubli"));
					pub = dtpu.getPubli(idpubli);
				%>
				
            <form  method="post" class="user" name="frm-foto" enctype="multipart/form-data" action="./Sl_FotoPublicacion">
                <div class="row gy-4">
                    <div class="col-md-12">
                    <div class="cuadro-fotoNima" align="center">
						<img id="preview" src="<%=pub.getImagen()==null?"#":pub.getImagen()%>" name="preview"  alt="Foto Publicacion"
									style="width: 400px; height: 400px; border-bottom-color: white; margin: 2px;" />
                    </div>

                    <div class="col-md-12">
                       <input type="file" id="foto" name="foto" onchange="Test.UpdatePreview(this)" >&nbsp; 
								
								<input type="hidden" name="idpubli" value="<%=idpubli%>">
                    </div>
                </div>
                <br>
