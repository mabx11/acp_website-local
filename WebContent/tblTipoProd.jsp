    ...
    <section id="about" class="about">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 row">
                	<div class="col">
			            <h1 class="h3 mb-2 text-gray-800">Gestión de Tipos de Productos</h1>
			            <!-- <p class="mb-4">Desde esta pantalla del sistema usted podrá
			                controlar la creación, actualización y el dar de baja a los roles.</p> -->
                  	</div>
                  	
                  	<div class="col" align="right">
                        <!-- Button agregar -->
                        <a href="NuevoTipoProd.jsp" data-toggle="modal" data-target="#modalNuevoRol">
                            <i class="fas fa-file-medical fa-2x" title="Agregar nuevo tipo de producto"></i>
                        </a>&nbsp;&nbsp; 
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="tblRol" width="100%"
                            ...
                            %>
                            <tr>
                                <td><%=tp.getTipoproductoid() %>
                                </td>
                                <td><%=tp.getTipoproducto() %>
                                </td>
                                <td><%=tp.getDescripcion() %>
                                </td>
                                <!--<td><%=tp.getEstado() !=3 ? "Activo" : "Inactivo" %>
                                </td>-->
                                <td class="text-center">
                                <a id="btn-edita-abrir" href="EditarTipoProd.jsp?TipoProdID=<%=tp.getTipoproductoid()%>"> <i
                                        class="fas fa-edit" title="Editar Tipo de Producto"></i>
                                </a>
                                <a class="ajax-link" href="javascript:void(0);" 
                                           		onclick="$.jAlert({
                                           		    ...
                                           		    'onConfirm': function(e, btn){
                                           		      ...
                                           		      window.location.href = 'Sl_GestionTipoProd?TipoProdID=<%=tp.getTipoproductoid()%>';
                        							...
                        							<i class="fas fa-trash-alt" title="Eliminar Tipo de Producto"></i>
                        						</a> 
...
<script>
    $(document).ready(function () {
        ...
        if(mensaje == "1")
        {
        	...
        	$.jAlert({
                ...
                'onClose': function(OnClose) {               
                    window.location = "tblTipoProd.jsp";
                }
              });
        }
        if(mensaje == "2")
        ...
        if(mensaje == "5")
        {
            //successAlert('Éxito', 'El rol ha sido dado de baja exitosamente');
            $.jAlert({
                'title': 'Éxito',
