<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
         pageEncoding="ISO-8859-1" import="entidades.Pais, vistas.VW_PaisRegion, datos.Dt_Pais, vistas.VW_RolUsuario, datos.Dt_RolOpciones, java.util.*;" %>
<%
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 row">
                    <div class="col">
                        <h1 class="h3 mb-2 text-gray-800">Gestión de País</h1>
                    </div>
                    <div class="col" align="right">
                        ...
                        <a href="NuevoPais.jsp" data-toggle="modal"
                           data-target="#modalNuevoUsuario"> <i
                                class="fas fa-file-medical fa-2x" title="Agregar nuevo país"></i>
                        </a>&nbsp;&nbsp;
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="tblPais" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td><%=pa.getEstado() != 3 ? "Activo" : "Inactivo" %>
	                       	    </td>
...
$(document).ready(function () {
   ...
   $('#tblPais').DataTable({
       ...
       if(mensaje == "1")
       {
       	//successAlert('Éxito', 'Los datos del país han sido registrados exitosamente');
           $.jAlert({
               'title': 'Éxito',
               'content': 'Los datos del país han sido registrados exitosamente',
               'theme': 'green',
               'onClose': function(OnClose) {               
                   window.location = "tblPais.jsp";
               }
             });
       }
       if(mensaje == "2")
