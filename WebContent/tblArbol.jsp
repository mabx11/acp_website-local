           ...
           <div class="card shadow mb-4">
               <div class="card-header py-3 row">
                   ...
                   <div class="col" align="right">
                       ...
                       <!-- Button imprimir-->
                       <a href="#" onclick="verRptArbol();"> 
                       	<i class="fas fa-print fa-2x" title="Imprimir registro"></i>
                       </a>
                       ...
                       <table class="table table-bordered" id="tblArbol" width="100%" cellspacing="0">
                           ...
                           <tr>
                               ...
                               <td><%=ar.getEpocaFloracion() %>
                                ...
                                <%-- <% 
				                    String nombred = ar.getDescripDistribucion();
				                    if(nombred==null)
				                    {
				                    	...
				                    	nombred = ar.getDescripDistribucion();
				                    }
				                %>
                               <td><%=nombred %>
                               </td> --%>
                               ...
                               <td>
                           	<%
                                		if(ar.getImagen() != null){
                                			
                                		%>
                                			<a target="_blank" href="<%=ar.getImagen() %>">
                                   ...
                                   <td><a id="btn-edita-abrir" href="EditarArboles.jsp?arbolID=<%=ar.getID() %>"> <i
                                       class="fas fa-edit" title="Editar árbol"></i></a>
                                   ...
                                   <a href="v_vistaArbol.jsp?arbolID=<%=ar.getID()%>"> <i class="fas fa-eye" title="Visualizar árbol"></i>
                                   </a>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if(mensaje == "1")
        {
            ...
            $.jAlert({
                'title': 'Éxito',
                'content': 'Los datos del árbol han sido registrados exitosamente',
                'theme': 'green',
                'onClose': function(OnClose) {               
                    window.location = "tblArbol.jsp";
                }
              });
        }
        if(mensaje == "2")
        ...
        if(mensaje == "7")
        {
            ...
            $.jAlert({
                'title': 'Éxito',
                'content': 'La foto del árbol se guardó exitosamente',
                'theme': 'green',
                'onClose': function(OnClose) {               
                    window.location = "tblArbol.jsp";
                }
		...
		if(mensaje == "8")
        {
            ...
            $.jAlert({
                'title': 'Advertencia',
                'content': 'La foto del árbol no se guardó en la base de datos',
                'theme': 'yellow',
                'onClose': function(OnClose) {               
                    window.location = "tblArbol.jsp";
                }
