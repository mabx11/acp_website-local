<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="entidades.Usuario, datos.Dt_Usuario, vistas.VW_RolUsuario, datos.Dt_RolOpciones, java.util.*;"%>
<%
					...
					<div class="form-group col-sm-6">
						<div class="col-sm-12">
							...
							<input type="Tel" class="form-control form-control-user"
								name="txttel" id="txttel" placeholder="Ingrese 0 si no posee número de contacto" minlength="8" maxlength="32" >
						</div>
						<div class="col-sm-12">
							Correo electrónico:
						...
						<div class="col-sm-10 mb-3 mb-sm-3 input-group">
							<div class="col-sm-8">
								<input id="show_pwds" class="btn btn-primary" type="button" onclick="myFunction()"
						...
						<div class="col-sm-10 mb-3 mb-sm-3 input-group">
							<input type="password" class="form-control form-control-user"
								name="txtPwd" id="txtPwd" placeholder="Nueva contraseña" minlength="8" maxlength="32" >
							<div class="input-group-append">
								<button id="show_password" class="btn btn-primary" type="button"
									onclick="mostrarPassword()">
									<span style="color:white;" class="fa fa-eye-slash iconm"></span>
								</button>
							</div>
						</div>
						<div class="col-sm-12">
...
function mostrarEditPwd() {
	var cambio = document.getElementById("pwds");
	if (cambio.type == "hidden") {
		cambio.type = "";
		$('.icon').removeClass('fa-solid fa-pen-slash').addClass('fa-solid fa-pen');
	} else {
		cambio.type = "";
		$('.icon').removeClass('fa-solid fa-pen').addClass('fa-solid fa-pen-slash');
	}
}
function mostrarPassword() {
	...
	if (cambio.type == "password") {
		cambio.type = "text";
		$('.iconm').removeClass('fa fa-eye-slash').addClass('fa fa-eye');
	} else {
		cambio.type = "password";
		$('.iconm').removeClass('fa fa-eye').addClass('fa fa-eye-slash');
	}
}
  ...
  $(document).ready(function()
{
	...
	//$("#txtPwdO").val("<%=user.getContrasenia()%>");
