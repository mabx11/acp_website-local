<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="vistas.*, datos.*, entidades.*, java.util.*;"%>
...
<main id="main">
	...
	<section id="about" class="about">
		...
		<div class="container" data-aos="fade-up">
			...
			<h2 class="form-header" style="color: black;">Registrar Tipo de Producto</h2>
			<br>
...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
		...
		if (mensaje == "existe") {
			errorAlert('Error', 'El tipo de producto que está intentando registrar ya existe en la base de datos');
		}
