           ...
           <div class="card shadow mb-4">
               <div class="card-header py-3 row">
                   ...
                   <div class="col" align="right">
                       <!-- Button agregar -->
                       <a href="NuevoProducto.jsp" data-toggle="modal"
                          data-target="#modalNuevoUsuario"> <i
                               class="fas fa-file-medical fa-2x" title="Agregar nuevo producto"></i>
                       </a>&nbsp;&nbsp;
                   ...
                   <div class="table-responsive">
                       <table class="table table-bordered" id="tblProductos" width="100%" cellspacing="0">
                           <%
                               ...
                               listVwProductos = dtp.listaVwProductos();
                           ...
                           <tbody>
                           <%
                               for (VW_Productos pro : listVwProductos) {
                           %>
                           <tr>
                               <td><%=pro.getID() %>
                               </td>
                               ...
                               <td><%=pro.getTipoProducto() %>
                               </td>
                               <td><%=pro.getDescripcion() %>
                               </td>
                               <td><%=pro.getDisponibilidad() %>
                               </td>
                           	...
                           	<%
                                		...
                                		%>
                                			<a target="_blank" href="<%=pro.getFoto() %>">
    		                           		<img src="<%= pro.getFoto() %>" style="max-height:100px; max-width:100px;" alt="...">
    		                           		</a>
                                	<% }else{
                                		%>
                                   ...
                                   <td><a id="btn-edita-abrir" href="EditarProducto.jsp?ProductoID=<%=pro.getID() %>"> <i
                                       class="fas fa-edit" title="Editar producto"></i></a>
                                   	...
                                   	<a class="ajax-link" href="javascript:void(0);" 
                                      		onclick="$.jAlert({
                                      		    ...
                                      		    'onConfirm': function(e, btn){
                                      		      ...
                                      		      window.location.href = 'Sl_GestionProductos?ProductoID=<%=pro.getID()%>';
                                   ...
                                   <a href="vistaProducto.jsp?ProductoID=<%=pro.getID()%>"> <i class="fas fa-eye" title="Visualizar producto"></i>
                                   </a>
                                   <a href="fotoProducto.jsp?idProducto=<%=pro.getID()%>">
                                   <i class="fas fa-camera" title="Registrar foto"></i></a></td>
                           </tr>
                           <%
                               }
                           %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if(mensaje == "1")
        {
        	 //successAlert('Éxito', 'Los datos del árbol han sido registrados exitosamente');
            $.jAlert({
                'title': 'Éxito',
                'content': 'Los datos del producto han sido registrados exitosamente',
                'theme': 'green',
                'onClose': function(OnClose) {               
                    window.location = "tblProductos.jsp";
                }
              });
        }
        if(mensaje == "2")
        ...
        if(mensaje == "5")
        {
        	 //successAlert('Éxito', 'Los datos han sido dados de baja exitosamente');
            $.jAlert({
                'title': 'Éxito',
        ...
        if(mensaje == "7")
        {
            ...
            $.jAlert({
                'title': 'Éxito',
                'content': 'La foto del producto se guardó exitosamente',
                'theme': 'green',
                'onClose': function(OnClose) {               
                    window.location = "tblProductos.jsp";
                }
		...
		if(mensaje == "8")
        {
            ...
            $.jAlert({
                'title': 'Advertencia',
                'content': 'La foto del producto no se guardó en la base de datos',
                'theme': 'yellow',
                'onClose': function(OnClose) {               
                    window.location = "tblProductos.jsp";
                }
