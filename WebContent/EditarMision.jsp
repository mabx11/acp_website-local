...
<main id="main">
    ...
    <section id="about" class="about">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <h2 class="form-header" style="color: black;">Edición de Misión</h2>
            <br>
            ...
            %>
            <form action="./Sl_GestionHome" method="post" class="user">
             <input name="homeID" type="hidden" value="<%=hom.getHomeID()%>" />
             <input name="opcion" type="hidden" value="2" />
                <div class="row gy-4">

                    <div class="col-md-12">
                        <textarea class="form-control" name="txtMision" id="txtMision" rows="6" placeholder="Contenido"
                                  required></textarea>
                    </div>
                </div>
