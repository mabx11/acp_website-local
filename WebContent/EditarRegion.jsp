        ...
        <div class="container" data-aos="fade-up">
            ...
            <!-- El valor de este input es para el Servlet opcion guardar -->
                ...
                <div class="button-formulario">
                    <input class="btn-user button button-formulario" type="submit" value="Guardar"/>
   ...
   $(document).ready(function()
	{
	   $("#txtname").val("<%=reg.getNombre()%>");
		...
		if (mensaje == "existe") {
			//errorAlert('Error','Los datos de la región que está intentando registrar ya existen en la base de datos');
			$.jAlert({
		       'title': 'Error',
		       'content': 'Los datos de la región que está intentando registrar ya existen en la base de datos',
		       'theme': 'red',
